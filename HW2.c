/*********************************
 ...
 Modify your Program 1 above so that, when executed, it will do the following in the indicated sequence:
  ...
  2. Ask the user to enter on the keyboard the ending value nstop of n.
  3. Ask the user to enter on the keyboard the increment nstep in n from one 
     value to the next.
  4. The program is then to display on the console a table consisting of two 
